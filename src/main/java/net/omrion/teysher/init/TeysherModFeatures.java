...
import net.omrion.teysher.world.features.ores.DaloushOreFeature;
...
public class TeysherModFeatures {
	private static final Map<Feature<?>, FeatureRegistration> REGISTRY = new HashMap<>();
	static {
		REGISTRY.put(DaloushOreFeature.FEATURE, new FeatureRegistration(GenerationStep.Decoration.UNDERGROUND_ORES, DaloushOreFeature.GENERATE_BIOMES,
				DaloushOreFeature.CONFIGURED_FEATURE));
	}
